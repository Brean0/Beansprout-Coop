...
contract AnchorCertificates is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked(certificateType, ' Beansprout Bond #',toString(certificates[tokenId].nr)));
    ...
    // egg mode -> seedling
    // chicken in -> beanstalk plant
    // chicken out -> dead plant 
